...
const NewsEconomy = () => {
  ...
  const funNewsApi = () => {
    ...
    newsApi
      .get(
        `/newsses?pagination[page]=${pagination.current}&pagination[pageSize]=${pagination.pageSize}&filters[categories][name][$contains]=Economy&populate=*&sort[0][publishedAt]=desc`
      )
      .then((res) => {
        setLoading(false);
