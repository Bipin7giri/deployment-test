        ...
        <>
          <Upload showUploadList={false} onChange={handleUpload}>
            <Avatar
              ...
              isUploading={true}
              icon={<UserOutlined />}
              className="bg-blue-500 text-primary   text-2xl flex justify-center items-center rounded-full hover:opacity-40 transition-opacity duration-300"
            />
          </Upload>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary   font-bold text-sm opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300">
            Edit Profile
          </div>
        </>
      )}
